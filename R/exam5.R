...
title <- gsub("[[:cntrl:]]", "", title) #정규표현식(regular expression)
title
...
writeBin(content(res, 'raw'), '/Users/KimJuHee/Desktop/coding/mycodesource/Multicampus/Rexam/httr.pdf')
...
for(i in 1:length(img.src)){
  ...
  writeBin(content(res, 'raw'), paste('/Users/KimJuHee/Desktop/coding/mycodesource/Multicampus/Rexam/data/', img.src[i], sep=""))
} 
